...
public class HiloServidor extends Thread {
    ...
    private static final Logger LOGGER = Logger.getLogger(HiloLanzador.class.getName());
...
//					mapa.getMt()[nroCliente][0] = 1;
        ...
        if (msgConcat[0].equals("ClicTirarBtn")) {
            ...
            enviarMensaje("Hola: " + nombres[nroCliente], clientes[nroCliente].getIp(), clientes[nroCliente].getPuerto());
            setNombresConcat();
            if (cantClientes >= 2) {
//				empieza = true;
                enviarMensajeATodos("nombresAntes1" + nombresConcat);
            } else {
                enviarMensaje("nombresAntes1" + nombresConcat, clientes[nroCliente].getIp(), clientes[nroCliente].getPuerto());
            }
